...
func (r *ReconcileCanaryDeploy) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling CanaryDeploy")

	// Fetch the CanaryDeploy instance
	instance := &canaryv1beta1.CanaryDeploy{}
	...
	// Set CanaryDeploy instance as the owner and controller
...
func newPodForCR(cr *canaryv1beta1.CanaryDeploy) *corev1.Pod {
